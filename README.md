...
- [Zoomla!逐浪CMS卓越出品](#zoomla逐浪cms卓越出品)
  - [逐浪官方开源精品全站项目060：摇篮报出版社整站程序（童趣美感卓越）](#逐浪官方开源精品全站项目060摇篮报出版社整站程序童趣美感卓越)
  - [本项目介绍](#本项目介绍)
- [开放性说明](#开放性说明)
  - [使用说明](#使用说明)
- [接口文档](#接口文档)
...
## 逐浪官方开源精品全站项目060：摇篮报出版社整站程序（童趣美感卓越）
...
这是一个出版社全站源码，基于.net mvc框架，基于Zoomla!逐浪CMS,集成商品、客服、商城、移动接口、软件发布、下载、图库诸多功能，是不可多得的复合型软件门户，开箱即用：
- 服务端基于Zoomla!逐浪CMS开发
- 前端web呈现基于Boostrap 
